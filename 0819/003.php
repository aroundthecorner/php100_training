<?php
	...
	if(isset($_POST['input_code'])){
		...
		if($input_code == $_SESSION['authcode']){
			$msg = "验证码正确";
		}else{
			$msg = "sorry,验证码错误";
		}
...
<head>
	...
	<style>
		*{font-size:16px;padding:0;margin:0;font-family:微软雅黑,Arial;}
		...
		#container{width:300px;margin:20px auto;background-color:#fff;padding:20px;}
...
<div id="container">
	...
	<img id="authocode" src="authcode.php" onclick="this.src='authcode.php';"><a href="" onclick="document.getElementById('authocode').src='authcode.php';return false;" class="intro_txt">看不清请点击图片</a>
