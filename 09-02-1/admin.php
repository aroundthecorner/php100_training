<?php
	...
	$sql_str = "select * from news,news_type where news.type=news_type.ttid order by uptime desc";
	$sql_str .= $sql_limit;
...
<html>
	...
	<body>
		...
		<table id="ad_list" cellspacing=1 cellpadding=0 >
			...
			?>
			<tr>
				<td colspan=9 style="text-align:right;padding-left:20px;">
					<?php
